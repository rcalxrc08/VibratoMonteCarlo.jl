...
makedocs(format = Documenter.HTML(prettyurls = get(ENV, "CI", nothing) == "true", assets = ["assets/favicon.ico"], repolink = "https://gitlab.com/rcalxrc08/VibratoMonteCarlo"), repo = "https://gitlab.com/rcalxrc08/VibratoMonteCarlo.git", sitename = "VibratoMonteCarlo", modules = [VibratoMonteCarlo], pages = ["index.md"])
get(ENV, "CI", nothing) == "true" ? deploydocs(repo = "https://gitlab.com/rcalxrc08/VibratoMonteCarlo.git") : nothing