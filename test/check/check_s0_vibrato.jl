using TaylorSeries,DualNumbers, FinancialMonteCarlo,VibratoMonteCarlo,HyperDualNumbers,FinancialFFT,FastGaussQuadrature,Test
S0 = 100.0;
...
result1 = vibrato_saltando(Model_t, rfCurve, mc, EUData, VibratoMonteCarlo.VibratoMonteCarloGaussHermite(200));
result2 = vibrato_saltando(Model_d, rfCurve, mc, EUData,  VibratoMonteCarlo.VibratoMonteCarloGaussHermite(200));
